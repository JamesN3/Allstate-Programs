...
class Client:
    ...
    def __init__(self, line):
        ...
        # Defaults url to error page for XHR request collection error
...
def add_list(line):
    ...
    def requester():
        ...
        try:
            ...
            client_line.mod_url = "Requests Exception"
        except requests.exceptions.HTTPError as errh:
            client_line.mod_url = "HTTP Error"
        except requests.exceptions.ConnectionError as errc:
            client_line.mod_url = "Connection Error"
        except requests.exceptions.Timeout as errt:
            client_line.mod_url = "Timeout Error" 
        except:
